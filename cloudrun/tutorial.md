...
[アーキテクチャ図](https://raw.githubusercontent.com/{{github-repo}}/main/images/step_by_step_deployment.png)
...
[アーキテクチャ図](https://raw.githubusercontent.com/{{github-repo}}/main/images/single_step_deployment.png)
...
[アーキテクチャ図](https://raw.githubusercontent.com/{{github-repo}}/main/images/canary_release.png)
...
[アーキテクチャ図](https://raw.githubusercontent.com/{{github-repo}}/main/images/limited_release.png)
...
[アーキテクチャ図](https://raw.githubusercontent.com/{{github-repo}}/main/images/cicd_pipeline.png)
...
### **3. サービスの設定** [![screenshot](https://raw.githubusercontent.com/{{github-repo}}/main/images/link_image.png)](https://raw.githubusercontent.com/{{github-repo}}/main/images/create_a_cloud_run_service.png)

1. サービス名に `sumservice` と入力します
1. リージョンは `asia-northeast1 (Tokyo)` を選択します
1. `次へ` ボタンをクリックします

### **4. サービスの最初のリビジョンの構成** [![screenshot](https://raw.githubusercontent.com/{{github-repo}}/main/images/link_image.png)](https://raw.githubusercontent.com/{{github-repo}}/main/images/configure_the_first_revision_of_the_service.png)

1. `ソース リポジトリから新しいリビジョンを継続的にデプロイする` をチェックします
1. `SET UP WITH CLOUD BUILD` ボタンをクリックします

### **5. Cloud Build の設定** [![screenshot](https://raw.githubusercontent.com/{{github-repo}}/main/images/link_image.png)](https://raw.githubusercontent.com/{{github-repo}}/main/images/configure_source_repository.png) [![screenshot](https://raw.githubusercontent.com/{{github-repo}}/main/images/link_image.png)](https://raw.githubusercontent.com/{{github-repo}}/main/images/configure_build.png) [![screenshot](https://raw.githubusercontent.com/{{github-repo}}/main/images/link_image.png)](https://raw.githubusercontent.com/{{github-repo}}/main/images/move_to_trigger_configuration.png)
...
### **6. このサービスをトリガーする方法の構成** [![screenshot](https://raw.githubusercontent.com/{{github-repo}}/main/images/link_image.png)](https://raw.githubusercontent.com/{{github-repo}}/main/images/configure_trigger.png)
...
### **7. 動作確認** [![screenshot](https://raw.githubusercontent.com/{{github-repo}}/main/images/link_image.png)](https://raw.githubusercontent.com/{{github-repo}}/main/images/access_deployed_service.png)
...
### **3. 動作確認** [![screenshot](https://raw.githubusercontent.com/{{github-repo}}/main/images/link_image.png)](https://raw.githubusercontent.com/{{github-repo}}/main/images/confirm_cicd_pipeline.png)
...
[アーキテクチャ図](https://raw.githubusercontent.com/{{github-repo}}/main/images/enhance_sample_application.png)
...
### **3. サービスの設定** [![screenshot](https://raw.githubusercontent.com/{{github-repo}}/main/images/link_image.png)](https://raw.githubusercontent.com/{{github-repo}}/main/images/create_a_cloud_run_service_currency.png)
...
### **5. Cloud Build の設定** [![screenshot](https://raw.githubusercontent.com/{{github-repo}}/main/images/link_image.png)](https://raw.githubusercontent.com/{{github-repo}}/main/images/configure_source_repository.png) [![screenshot](https://raw.githubusercontent.com/{{github-repo}}/main/images/link_image.png)](https://raw.githubusercontent.com/{{github-repo}}/main/images/configure_build_currency.png) [![screenshot](https://raw.githubusercontent.com/{{github-repo}}/main/images/link_image.png)](https://raw.githubusercontent.com/{{github-repo}}/main/images/move_to_trigger_configuration.png)
...
```bash
git add . && git commit -m "Add integration to currencyservice" && git push google main
```
...
[アーキテクチャ図](https://raw.githubusercontent.com/{{github-repo}}/main/images/security.png)
...
### **2. Container Analysis の有効化** [![screenshot](https://raw.githubusercontent.com/{{github-repo}}/main/images/link_image.png)](https://raw.githubusercontent.com/{{github-repo}}/main/images/enable_container_analysis.png)

Container Analysis を有効化するにはプロジェクト単位で機能を有効化します。

左メニューの `設定` をクリックし、次のページで脆弱性スキャンを `オン` にします。

### **3. コンテナの再アップロード** [![screenshot](https://raw.githubusercontent.com/{{github-repo}}/main/images/link_image.png)](https://raw.githubusercontent.com/{{github-repo}}/main/images/click_cloudrun_handson.png) [![screenshot](https://raw.githubusercontent.com/{{github-repo}}/main/images/link_image.png)](https://raw.githubusercontent.com/{{github-repo}}/main/images/click_sumservice.png)
...
### **4. スキャン結果の確認** [![screenshot](https://raw.githubusercontent.com/{{github-repo}}/main/images/link_image.png)](https://raw.githubusercontent.com/{{github-repo}}/main/images/container_analysis_result.png)
...
```bash
git add . && git commit -m "Update to use a token accessing currencyservice" && git push google main
```

### **3. currencyservice の呼び出し許可設定修正**
...
### **1. Locust からの負荷テスト** [![screenshot](https://raw.githubusercontent.com/{{github-repo}}/main/images/link_image.png)](https://raw.githubusercontent.com/{{github-repo}}/main/images/locust_ui.png)
...
[アーキテクチャ図](https://raw.githubusercontent.com/{{github-repo}}/main/images/global_deployment.png)
